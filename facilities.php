  ...
  #about
{
  ...
  <script type="text/javascript">
    ...
    window.onscroll=function(){
      ...
      if(top>=50){
        ...
        document.getElementById("Nav1").style.backgroundColor = "darkgrey";
  ...
  <div class="NavbarContainer">
    <img src="videos\buses.mp4" alt="" class="NavLogo" onclick="rtohome()">
    <div class="MobileIcon">
    <i class="fa fa-bars"></i>
    </div>
    <ul class="NavMenu ">
      <!-- <li class="NavItem"><a id="linkcolor" on class="NavLinks" href="#about">About</a></li> -->
      <li class="NavItem" ><a style="text-decoration: none;" id="linkcolor1" class="NavLinks" href="pricing.php">Pricing</a></li>
      <!-- <li class="NavItem"><a id="linkcolor2" class="NavLinks" href="#contact">Contact Us</a></li> -->
      <li class="NavItem" style="text-decoration: none;"><a style="text-decoration: none;" id="linkcolor3" class="NavLinks" href="signin.php">Sign in</a></li>
    </ul>
    <div class="NavBtn">
...
<div class="container-fluid" style="margin-top: 10px;">
   ...
   border-width: 5px; border-color: gray; float: left;height: 320px;">
    <img class="card-img-top" src="power.jpg" alt="Card image cap">
    <div class="card-body">
...
<div class="col-3">
  ...
  border-width: 5px; border-color: gray; float: left;height: 320px;">
    <img class="card-img-top" src="ro.jpeg" alt="Card image cap">
    <div class="card-body">
...
<div class="col-3">
  ...
  border-width: 5px; border-color: gray; float: left;">
    <img class="card-img-top" src="wifi.jpg" alt="Card image cap">
    <div class="card-body">
...
<div class="container-fluid" style="margin-top: 10px;">
    ...
    <div class="card text-white bg-secondary mb-3" style="width: 18rem; margin-top: 10%; margin-left:2%;  border-radius:10px;   border-style: solid;
  border-width: 5px; border-color: gray; float: left; height:320px;">
    <img class="card-img-top" src="bank.jpg" alt="Card image cap">
    <div class="card-body">
...
<div class="col-3">
  ...
  border-width: 5px; border-color: gray; float: left;">
    <img class="card-img-top" src="postoffice.jpg" alt="Card image cap">
    <div class="card-body">
...
<div class="col-3">
    <div class="card text-white bg-secondary mb-3" style="width: 19rem;margin-top: 10%; margin-left:2%;  border-radius:10px;   border-style: solid; height: 320px;
  border-width: 5px; border-color: gray; float: left;">
    <img class="card-img-top" src="dispensary.jpeg" alt="Card image cap">
    <div class="card-body">
...
<div class="col-3">
    <div class="card text-white bg-secondary mb-3" style="width: 18rem; height: 320px; margin-top: 10%; margin-left:2%;  border-radius:10px;   border-style: solid;
  border-width: 5px; border-color: gray; float: left;">
    <img class="card-img-top" src="dpe.jpeg" alt="Card image cap">
    <div class="card-body">
...
<button style="margin-bottom: 5%; font-size: 1.5em; font-family:sans-serif " type="button" name="button" class="NavBtnLink"  onclick="return change()">Register</button>
  </div>
</div>
