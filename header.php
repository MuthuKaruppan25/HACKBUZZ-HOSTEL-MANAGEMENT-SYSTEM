  ...
  <body>
    <div class="Nav" id="Nav1">
      <div class="NavbarContainer">
        <img src="../images/\/kec_logo.jpeg"  style="border-radius:60%;  color:white; font-size:2em; font-family:casteller"alt="KEC" class="NavLogo" onclick="rtohome()">
        <div class="MobileIcon">
        <i class="fa fa-bars"></i>
        </div>
    <ul class="NavMenu ">
      <li style="color:white;padding-top:30px; margin-left:100px; font-family: Algerian;font-size :1.5em;" class="NavItem"><?php echo "Welcome $regno"; ?></li>
    </ul>
        <!-- <ul class="NavMenu ">
