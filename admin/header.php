...
<html lang="en" dir="ltr">
  <head>
    <?php
    $conn23= mysqli_connect('localhost','root','','hms') or die("Connection failed:" .mysqli_connect_error());
    if (session_status() === PHP_SESSION_NONE) {
        session_start();
    }
     $employeeid= $_SESSION['employeeid'];
     $query21="select empname from admin where employeeid= $employeeid";
  ...
  <body >
    <div class="Nav" id="Nav1" style="background: black;">
      <div class="NavbarContainer" >
        <img src="/images\kec_logo.jpeg" alt="KEC" class="NavLogo" style="border-radius: 100%; color:white;" onclick="rtohome()">
