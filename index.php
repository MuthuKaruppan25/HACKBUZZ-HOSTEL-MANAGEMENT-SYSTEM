...
<div class="Nav" id="Nav1">
 ...
 <div class="HeroContainer">
  ...
  <source src="videos\bliss_of_kec.mp4" type="video/mp4">
 </video>
</div>
...
<p class="TopLine" style="color:black">World class facilities</p>
<h1 class="Heading"style="color:black">Best facilities with less prices</h1>
<p class="Subtitle"style="color:black">Cherish your hostel life with our hostels</p>
<div class="BtnWrap">
<button type="button" name="button" class="NavBtnLink" onclick="return abc()">Get Started</button>
</div>
</div>
</div>
...
<div class="Column2">
<div class="ImgWrap">
<img class="Img" src="ponnar.jpg" alt="IMAGE" style="border-radius:40px">
</div>
</div>
</div>
</div>
...
<p class="Subtitle">World class dishes across the world </p>
<div class="BtnWrap">
...
<div class="Column2">
<div class="ImgWrap">
<img class="Img" src="hostelfood.jpg"  style="border-radius:40%"alt="FOOD">
</div>
</div>
</div>
</div>
  ...
  <div class="FooterLinksContainer">
    <div class="FooterLinksWrapper">
        <div class="FooterLinkItems">
            ...
            <a href="aboutme.php" class="FooterLink"  style="margin-bottom: 8%;" >Developers</a>
            <a href="#about" class="FooterLink"  style="margin-bottom: 8%;">Services</a>
            <a href="pricing.php" class="FooterLink"  style="margin-bottom: 8%;" >Pricing</a>
            <a href="admin\adminlogin.php" style="margin-bottom: 8%;" class="FooterLink">Admin</a>
        </div>
    </div>
  </div>
